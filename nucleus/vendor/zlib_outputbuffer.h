...
#ifndef THIRD_PARTY_NUCLEUS_VENDOR_ZLIB_OUTPUTBUFFER_H_
#define THIRD_PARTY_NUCLEUS_VENDOR_ZLIB_OUTPUTBUFFER_H_
...
#endif  // THIRD_PARTY_NUCLEUS_VENDOR_ZLIB_OUTPUTBUFFER_H_
