...
#ifndef THIRD_PARTY_NUCLEUS_VENDOR_ZLIB_COMPRESSION_OPTIONS_H_
#define THIRD_PARTY_NUCLEUS_VENDOR_ZLIB_COMPRESSION_OPTIONS_H_
...
#endif  // THIRD_PARTY_NUCLEUS_VENDOR_ZLIB_COMPRESSION_OPTIONS_H_
